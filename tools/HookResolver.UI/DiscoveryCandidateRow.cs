...
public sealed class DiscoveryCandidateRow
{
    public DiscoveryCandidateRow(StringDiscoveryCandidate candidate)
    {
        Candidate = candidate;
        Va = $"0x{candidate.Va:X8}";
        PushSiteVa = $"push @ 0x{candidate.PushSiteVa:X8}";
